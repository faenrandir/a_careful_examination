...
2. Brigham Young never taught the Adam/God doctrine. (see {{ link(text="public statements by McConkie and Boyd Kirkland's letter", path="/bruce-r-mcconkie-misled-on-adam-god/") }})
3. The Book of Mormon contains the fulness of the gospel and is a real history of real people in a real place living at in a specific time. (for example, {{ link(text="Your Fringe Benefits", path="/legrand-richards-your-fringe-benefits-secular-bom-comparison/") }})
