...
But I'm unaware of any way in which a **literal** Adam and Eve, an Adam and Eve who 1) tilled the earth, 2) had domesticated animals, and 3) were the literal parents to all humans on earth today) may be reconciled with the human migration data.  I detail [how a typical reconciliation attempt falls short](/review-of-ogdens-chapter-accepting-evolution-with-joy/) (in this case an attempt from an LDS professor who studies evolution, T. Heath Ogden).
