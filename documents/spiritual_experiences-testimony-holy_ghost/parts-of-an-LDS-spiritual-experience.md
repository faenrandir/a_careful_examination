The archetypal LDS spiritual experience involves a _mixture_ of these 4 things:
...
4. Congruence with accepted LDS doctrine or current policy: by definition, any inspiration which is received that does not affirm LDS doctrine and current policy is not considered The Spirit™.  This was canonized in a 1913 First Presidency Statement:
...
So, while #1 may be shared by people of all religions (and maybe #3 to some extent), it won't really matter to a Latter-day Saint because they can dismiss other experiences based on #2, #3, or #4.  Here are some examples:
