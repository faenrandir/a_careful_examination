...
With that said, I think there are a few good examples of where the Church (or its representatives) appear to have failed to inform members or investigators of things they perhaps should have (i.e., they knew about things that are relevant to LDS truth-claims and they failed to make those readily available or transparent) or misrepresented the data.  I am hesitant to label these "hiding." *Hiding* can be seen as implying motivation and/or dishonesty.  I would rather just concede at the the outset that LDS leadership probably genuinely view their own actions as honest and honorable.  For instance, they might personally classify all of their actions as one of the following: 1) an honest mistake 2) benign ignorance, 3) appropriate for their calling as a representative of the Church and its interests, 4) necessary steps to protect the innocent or those immature in the faith, 5) defending the faith, 6) refusing to "cast pearls before swine", or 7) following scriptural admonitions to be cautious in sharing sacred material.
