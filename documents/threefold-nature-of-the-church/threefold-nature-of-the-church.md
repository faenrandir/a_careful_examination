...
Totalistic groups tend to use [thought-reform methods](http://www.exitsupportnetwork.com/artcls/mindctrl/lifton.htm) (e.g., milieu control, mystical manipulation, demand for purity, confession, loading the language, doctrine over people, dispensing of existence) to exert influence over their members.[^totalisticexamples]  Virtually all totalistic groups justify whatever level of control they exert as the appropriate level of control given the importance of their mission.[^sweeping]
...
* Milieu control
    ...
    * [Finances not disclosed since 1959](https://www.dialoguejournal.com/wp-content/uploads/sbi/articles/4804_taxdaysb.pdf) and [leaders' compensation not disclosed](http://en.fairmormon.org/Mormonism_and_church_finances/No_paid_ministry/General_Authorities_living_stipend)
...
(*Critical Source*) [Families, Eternity, & Collateral Damage](https://www.youtube.com/v/opGwPHWvp5I?start=0&end=835) is a video that gives specific examples of the tension the totalistic mindset can generate within a family when a member leaves or questions the faith.  Admittedly, the repurcussions can be more severe in more totalistic organizations, but this video is good for pointing out common threads across a range of somewhat diverse totalistic mindsets.
...
[^totalisticexamples]:  It is easier to spot thought-reform methods and totalistic attitudes when one is viewing them through the lens of a different ideology than one's own native ideology:
